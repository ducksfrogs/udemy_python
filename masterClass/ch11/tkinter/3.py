...
rightrFrame.grid(row=1, column=2, sticky='n')
...
rightrFrame.config(relief='sunken', borderwidth=1)
leftFrame.grid(sticky='ns')
rightrFrame.grid(sticky='new')

rightrFrame.columnconfigure(0, weight=1)
